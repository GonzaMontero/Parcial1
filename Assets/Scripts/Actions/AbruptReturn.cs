...
public class AbruptReturn : FSMAction
{
    ...
    public AbruptReturn(Action<int> onSetFlag, Func<Vector2> onGetPos, Func<Vector2Int, Vector2Int, List<Vector2Int>> onGetPath,
        Action<Vector2Int> onUpdateTarget, Action stopFlocking, Vector2Int rest)
    {
