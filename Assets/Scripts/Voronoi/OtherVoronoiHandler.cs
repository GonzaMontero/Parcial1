...
public class OtherVoronoiHandler : MonoBehaviour
{
    ...
    public static List<MineItem> Mines = new List<MineItem>();
    public static List<MineItem> CurrentWorkedMines = new List<MineItem>();
    #endregion
